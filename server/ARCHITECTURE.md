...
Shared cross-cutting code lives under `server/src/services/` (audit, workflow-engine, arn-generator, moa-auto-create).
...
Module: `server/src/modules/marketing/` — **read-only** surface for `MKT_EXEC` (Diya Sharma).
